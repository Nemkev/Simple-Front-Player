...
export const HLSAudioPlayer = (props: Props) => {
      ...
      hlsRef.current.on(Hls.Events.MEDIA_ATTACHED, () => {
        ...
        hlsRef.current?.on(Hls.Events.MANIFEST_PARSED, () => {
          hlsRef.current?.on(
            ...
            (_: string, data: Hls.levelLoadedData) => {
    ...
    <div className={styles.hlsAudioPlayer}>
      ...
      <div className={styles.volumeControls}>
        <div className={styles.volumeWrapper}>
          ...
          <div
            className={styles.volumeLevelLine}
            style={{ width: `${volume * 100}%` }}
          />
          <div
            className={styles.volumeThumb}
            style={{ marginLeft: `calc(${volume * 100}% - 8px)` }}
          />
          <input
            type="range"
            min="0"
        ...
        <div className={styles.volumeButton} onClick={onMute}>
          <img
            src={isMuted || volume === 0 ? volumeOffButton : volumeOnButton}
          />
        </div>
      </div>
    </div>
